...
public class SnufflesItems {
    ...
    public static final Item SNUFFLE_FLUFF = new FuelBlockItem(SnufflesBlocks.SNUFFLE_FLUFF, 100, new FabricItemSettings());
    public static final Item FROSTY_FLUFF = new BlockItem(SnufflesBlocks.FROSTY_FLUFF, new FabricItemSettings());
    public static final Item SNUFFLE_FLUFF_CARPET = new FuelBlockItem(SnufflesBlocks.SNUFFLE_FLUFF_CARPET, 67,new FabricItemSettings());
    public static final Item FROSTY_FLUFF_CARPET = new BlockItem(SnufflesBlocks.FROSTY_FLUFF_CARPET, new FabricItemSettings());
    public static final Item SNUFFLE_SPAWN_EGG = new SpawnEggItem(SnufflesEntityTypes.SNUFFLE, 16777215, 7125720, new FabricItemSettings());
